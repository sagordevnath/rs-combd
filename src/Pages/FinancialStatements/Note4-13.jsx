...
const Note4To13 = () => {
  return (
    <div className="w-auto">
        ...
        <div className="container">
          ...
          <div className="row pr-0">
            <div className="col-2 offset-8">
              <p className="text-end border-btm pb-1">In Bangladesh Taka</p>
            </div>
            <div className="col-2">
              <p className="text-end border-btm pb-1">In Bangladesh Taka</p>
            </div>
      ...
      <div className="note-all-content pb-3">
        <div className="container">
          ...
          <div className="single-note">
            ...
            <div className="row">
              <div className="col-7 offset-1">
                <p>Property, plant and equipment are in active use</p>
              </div>
              <div className="col-2">
                <p className="text-end">2,938,477</p>
              </div>
            ...
            <div className="row">
              <div className="col-7 offset-1">
                <p>Assets under construction (AUC) or temporarily idle</p>
              </div>
              <div className="col-2">
                <p className="text-end">2,938,477</p>
              </div>
            ...
            <div className="row">
              <div className="col-7 offset-1">
                <p>Fully depreciated assets are still in use - cost (0)</p>
              </div>
              <div className="col-2">
          ...
          <div className="single-note">
            ...
            <div className="row">
              <div className="col-2 offset-8">
                <p className="text-end">17,576,078</p>
              </div>
              <div className="col-2">
                <p className="text-end">12,623,554</p>
              </div>
            </div>
            <div className="row">
              <div className="col-7 offset-1">
            ...
            <div className="row">
              <div className="col-2 offset-8">
                <p className="text-end border-btm-2 fw-bold">17,576,078</p>
              </div>
              <div className="col-2">
                <p className="text-end border-btm-2 fw-bold">12,623,554</p>
              </div>
            </div>
          </div>
          <div className="single-note">
          ...
          <div className="single-note margin-btm-30">
            ...
            <div className="row">
              ...
              <div className="col-2">
                <p className="text-end border-btm-2 fw-bold">500,000</p>
              </div>
              <div className="col-2">
                <p className="text-end border-btm-2 fw-bold">500,0007</p>
              </div>
            </div>
            <div className="row">
              <div className="col-2 offset-4">
                <p className="border-btm text-center">No of shares</p>
              </div>
              <div className="col-2">
                <p className="border-btm text-center">Ratio</p>
              </div>
            </div>
            <div className="row">
            ...
            <div className="row">
              ...
              <div className="col-2">
                <p className="text-end border-btm-2 fw-bold">100%</p>
              </div>
              <div className="col-2">
                <p className="text-end border-btm-2 fw-bold">2,623,554</p>
              </div>
          ...
          <div className="single-note margin-btm-30">
            ...
            <div className="row">
              <div className="col-7 offset-1">
                <p>Total comprehensive income for the year</p>
              </div>
              <div className="col-2">
                <p className="text-end border-btm">8,037,677</p>
              </div>
          ...
          <div className="single-note margin-btm-30">
            ...
            <div className="row">
              <div className="col-2 offset-4">
                <p className="border-btm text-center">Non-current</p>
              </div>
              <div className="col-2">
                <p className="border-btm text-center">Current</p>
              </div>
            </div>
            <div className="row">
              <div className="col-3 offset-1">
          ...
          <div className="single-note margin-btm-30">
            ...
            <div className="row">
              <div className="col-7 offset-1">
                <p>Opening deferred tax liability (up to 30 June 2022)</p>
              </div>
              <div className="col-2">
                <p className="text-end">2,938,477</p>
              </div>
            ...
            <div className="row">
              <div className="col-7 offset-1">
                <p>Adjustment during the year</p>
              </div>
              <div className="col-2">
                <p className="text-end border-btm">-</p>
              </div>
          ...
          <div className="single-note margin-btm-30">
            ...
            <div className="row">
              <div className="col-3 offset-1 pl-0 border-btm">
                <p className="text-center fw-bold">Assets/(liability)</p>
              </div>
              <div className="col-2 pl-0 border-btm">
                <p className="text-center fw-bold">Carrying value</p>
              </div>
              <div className="col-2 pl-0 border-btm">
                <p className="text-center fw-bold">Tax base value</p>
              </div>
              <div className="col-2 pl-0 border-btm">
                <p className="text-center fw-bold">
                  Cumulative temporary difference taxable(refundable)
                </p>
              </div>
              <div className="col-2 pl-0 border-btm">
                <p className="text-center fw-bold">
            ...
            <div className="row">
              ...
              <div className="col-2">
                <p className="text-end">7,576,078</p>
              </div>
              <div className="col-2">
                <p className="text-end">7,576,078</p>
              </div>
            ...
            <div className="row">
              <div className="col-3 offset-1 border-btm pl-0">
          ...
          <div className="single-note margin-btm-30">
            ...
            <div className="row">
              ...
              <div className="col-2">
                <p className="text-end border-btm">380,000</p>
              </div>
              <div className="col-2">
                <p className="text-end border-btm">380,000</p>
              </div>
          ...
          <div className="single-note margin-btm-30">
            ...
            <div className="row">
              <div className="col-7 offset-1">
                <p>Advance received from customers</p>
              </div>
              <div className="col-2">
            ...
            <div className="row">
              <div className="col-7 offset-1">
                <p>Security money advance received from customers</p>
              </div>
              <div className="col-2">
                <p className="text-end border-btm">380,000</p>
              </div>
          ...
          <div className="single-note margin-btm-30">
            ...
            <div className="row">
              <div className="col-7 offset-1">
                <p>Payable for packaging materials</p>
              </div>
              <div className="col-2">
                <p className="text-end">380,000</p>
              </div>
            ...
            <div className="row">
              <div className="col-7 offset-1">
                <p>Payable for transport contractors</p>
              </div>
              <div className="col-2">
                <p className="text-end">380,000</p>
              </div>
            ...
            <div className="row">
              <div className="col-7 offset-1">
                <p>Payable for other services</p>
              </div>
              <div className="col-2">
                <p className="text-end border-btm">380,000</p>
              </div>
          ...
          <div className="single-note margin-btm-30">
            ...
            <div className="row">
              <div className="col-7 offset-1">
                <p>Outstanding wages, salary and allowances</p>
              </div>
              <div className="col-2">
                <p className="text-end">380,000</p>
              </div>
            ...
            <div className="row">
              <div className="col-7 offset-1">
                <p>Provision for professional fees</p>
              </div>
              <div className="col-2">
                <p className="text-end">380,000</p>
              </div>
          ...
          <div className="single-note margin-btm-30">
            ...
            <div className="row">
              <div className="col-7 offset-1">
                <p>Distributor's product price discount</p>
              </div>
              <div className="col-2">
                <p className="text-end">-</p>
              </div>
            ...
            <div className="row">
              <div className="col-7 offset-1">
                <p>Distributor's volume discount</p>
              </div>
              <div className="col-2">
                <p className="text-end">-</p>
              </div>
            ...
            <div className="row">
              <div className="col-7 offset-1">
                <p>Channel sale commission/rebate</p>
              </div>
              <div className="col-2">
                <p className="text-end">-</p>
              </div>
            ...
            <div className="row">
              <div className="col-7 offset-1">
                <p>Sales performance incentive rebate</p>
              </div>
              <div className="col-2">
                <p className="text-end">-</p>
              </div>
          ...
          <div className="single-note margin-btm-30">
            ...
            <div className="row">
              <div className="col-7 offset-1">
                <p>Opening inventory - Finished goods</p>
              </div>
              <div className="col-2">
                <p className="text-end">380,000</p>
              </div>
            ...
            <div className="row">
              <div className="col-7 offset-1">
                <p>Cost of production (Note: 24.01)</p>
              </div>
              <div className="col-2">
                <p className="text-end border-btm">380,000</p>
              </div>
            ...
            <div className="row">
              <div className="col-7 offset-1">
                <p>Closing inventory - Finished goods (Note: 6)</p>
              </div>
              <div className="col-2">
                <p className="text-end border-btm">380,000</p>
              </div>
          ...
          <div className="single-note margin-btm-30">
            ...
            <div className="row">
              <div className="col-7 offset-1">
                <p>Materials used in production (Note: 24.02)</p>
              </div>
              <div className="col-2">
                <p className="text-end">380,000</p>
              </div>
            ...
            <div className="row">
              <div className="col-7 offset-1">
                <p>Production overhead (Note: 24.03)</p>
              </div>
              <div className="col-2">
                <p className="text-end border-btm">380,000</p>
              </div>
          ...
          <div className="single-note margin-btm-30">
            ...
            <div className="row">
              <div className="col-3 offset-1">
                <p>Opening Raw and packing materials</p>
              </div>
              <div className="col-2">
                <p className="text-end">8,037,677</p>
              </div>
            ...
            <div className="row">
              <div className="col-3 offset-1">
                <p>Closing Raw and packing materials</p>
              </div>
              <div className="col-2">
                <p className="text-end border-btm">8,037,677</p>
              </div>
          ...
          <div className="single-note margin-btm-30">
            ...
            <div className="row mb-4">
              <div className="col-7 offset-1">
                <p>Opening inventory Work-in-progress</p>
              </div>
              <div className="col-2">
                <p className="text-end border-btm">380,000</p>
              </div>
            ...
            <div className="row">
              <div className="col-11 offset-1">
                <h5 className="font-16">Manufacturing overhead</h5>
              </div>
            </div>
            <div className="row">
              <div className="col-7 offset-1">
            ...
            <div className="row">
              <div className="col-7 offset-1">
                <p>Production supplies and spare parts used (Note: 24.04)</p>
              </div>
              <div className="col-2">
                <p className="text-end">380,000</p>
              </div>
            ...
            <div className="row">
              <div className="col-7 offset-1">
                <p>Machinery repairs and maintenance</p>
              </div>
              <div className="col-2">
                <p className="text-end">380,000</p>
              </div>
            ...
            <div className="row">
              <div className="col-7 offset-1">
                <p>Depreciation expense (Annexure A)</p>
              </div>
              <div className="col-2">
                <p className="text-end">380,000</p>
              </div>
            ...
            <div className="row">
              <div className="col-7 offset-1">
                <p>Amortization expense (Annexure A)</p>
              </div>
              <div className="col-2">
                <p className="text-end border-btm">380,000</p>
              </div>
            ...
            <div className="row">
              <div className="col-7 offset-1">
                <p>Closing inventory Work-in-progress (Note 6)</p>
              </div>
              <div className="col-2">
                <p className="text-end border-btm">380,000</p>
              </div>
          ...
          <div className="single-note margin-btm-30">
            ...
            <div className="row">
              <div className="col-7 offset-1">
                <p>Opening Production supplies and spare parts</p>
              </div>
              <div className="col-2">
                <p className="text-end">380,000</p>
              </div>
            ...
            <div className="row">
              <div className="col-7 offset-1">
                <p>Spare parts purchased during the year</p>
              </div>
              <div className="col-2">
                <p className="text-end">380,000</p>
              </div>
            ...
            <div className="row">
              <div className="col-7 offset-1">
                <p>Closing Production supplies and spare parts (Note 6)</p>
              </div>
              <div className="col-2">
                <p className="text-end border-btm">380,000</p>
              </div>
          ...
          <div className="single-note margin-btm-30">
            ...
            <div className="row">
              <div className="col-7 offset-1">
                <p>Loss on sale of assets (25.01)</p>
              </div>
              <div className="col-2">
                <p className="text-end">380,000</p>
              </div>
          ...
          <div className="single-note margin-btm-30">
            ...
            <div className="row">
              <div className="col-11 offset-1">
                <p>a. Property, plant and equipment</p>
              </div>
            </div>
            <div className="row">
              <div className="col-7 offset-1">
                <p>Sales proceeds of assets</p>
              </div>
              <div className="col-2">
                <p className="text-end">380,000</p>
              </div>
            ...
            <div className="row">
              <div className="col-7 offset-1">
                <p>Written down value [-35000-(-5000)]</p>
              </div>
              <div className="col-2">
                <p className="text-end border-btm">380,000</p>
              </div>
            ...
            <div className="row">
              <div className="col-7 offset-1">
                <p>Written down value [-20000-(-5000)]</p>
              </div>
              <div className="col-2">
                <p className="text-end border-btm">380,000</p>
              </div>
          ...
          <div className="single-note margin-btm-30">
            ...
            <div className="row">
              <div className="col-7 offset-1">
                <p>Product sample costs (Note: 24)</p>
              </div>
              <div className="col-2">
                <p className="text-end">380,000</p>
              </div>
          ...
          <div className="single-note margin-btm-30">
            ...
            <div className="row">
              <div className="col-7 offset-1">
                <p>Interest on borrowings from bank-HPSM</p>
              </div>
              <div className="col-2">
                <p className="text-end">380,000</p>
              </div>
            ...
            <div className="row">
              <div className="col-7 offset-1">
                <p>Interest on borrowings from bank-overdraft</p>
              </div>
              <div className="col-2">
                <p className="text-end">380,000</p>
              </div>
            ...
            <div className="row">
              ...
              <div className="col-2">
                <p className="text-end border-btm">80,000</p>
              </div>
            </div>
            <div className="row">
              <div className="col-2 offset-8">
          ...
          <div className="single-note margin-btm-30">
            ...
            <div className="row">
              <div className="col-7 offset-1">
                <p>Deferred tax expense (refundable adjustment)</p>
              </div>
              <div className="col-2">
                <p className="text-end border-btm">380,000</p>
              </div>
