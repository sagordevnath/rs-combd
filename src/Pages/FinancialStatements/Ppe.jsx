...
const Ppe = () => {
    ...
    <table className='width'>
        <tr className='height-25'>
            ...
            <th rowSpan={4}>as per company's statement heads</th>
            <th colSpan={4}>Costs</th>
            <th colSpan={5}>Accumulated depreciation and impairment</th>
            <th rowSpan={2}>W.D.V</th>
            <th rowSpan={2}>W.D.V</th>
        </tr>
        <tr>
            <td>Balance at</td>
    ...
    <div className="note-header pt-3">
        <div className="container-fluid">
            <div className="row">
                <div className="col-12">
                    <h5 className="mb-3">Intangible assets
                        <br /> As at 30 June 2023
                    </h5>
                </div>
            </div>
        </div>
    ...
    <table className='width'>
        ...
        <tr className='height-25 border-btm-2'>
