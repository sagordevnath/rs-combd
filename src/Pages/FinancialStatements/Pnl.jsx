...
const Pnl = () => {
    return (
      <div className="w-auto">
          ...
          <div className="container">
            ...
            <div className="row">
              <div className="col mt-2">
                <h5>Statement of profit or loss and other comprehensive income</h5>
              </div>
            </div>
        ...
        <div className="border-btm-2 mt-3"></div>
        <div className="container">
        ...
        <div className="container">
          <div className="single-note">
            ...
            <div className="row">
              <div className="col-5 offset-1 border-btm-2">
                <h5>Earnings before interest and tax (EBIT)</h5>
              </div>
              <div className="col-2">
                <p className="text-end fw-bold border-btm-2">7,576,078</p>
              </div>
